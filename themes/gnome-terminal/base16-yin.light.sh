#!/usr/bin/env bash
# Base16 Yin - Gnome Terminal color scheme install script
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "'#FFFFFF:#777777:#777777:#777777:#222222:#222222:#222222:#555555:#BBBBBB:#777777:#777777:#777777:#222222:#222222:#222222:#222222'"
...
gset string palette "#222222:#777777:#777777:#777777:#222222:#222222:#222222:#555555:#BBBBBB:#777777:#777777:#777777:#222222:#222222:#222222:#FFFFFF"
